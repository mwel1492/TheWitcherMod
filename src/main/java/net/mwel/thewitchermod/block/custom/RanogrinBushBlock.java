...
public class RanogrinBushBlock extends PlantBlock {
    public RanogrinBushBlock(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModBlocks.ranogrin_bush);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            RanogrinBushBlock.dropStack(world, pos, new ItemStack(ModItems.ranogrin, j + (bl ? 1 : 0)));
