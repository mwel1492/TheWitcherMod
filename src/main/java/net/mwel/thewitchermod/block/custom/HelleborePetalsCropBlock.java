...
public class HelleborePetalsCropBlock extends CropBlock {
    public HelleborePetalsCropBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            HelleborePetalsCropBlock.dropStack(world, pos, new ItemStack(ModItems.hellebore_petals, j + (bl ? 1 : 0)));
    ...
    protected ItemConvertible getSeedsItem() {
        return ModItems.hellebore_petals;
    }
