...
public class BloodmossWallPlant extends MultifaceGrowthBlock implements Fertilizable {
    private final LichenGrower grower = new LichenGrower(this);

    public BloodmossWallPlant(Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModBlocks.bloodmoss_wall_plant);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 2) {
            ...
            BloodmossWallPlant.dropStack(world, pos, new ItemStack(ModItems.bloodmoss, j + (bl ? 1 : 0)));
