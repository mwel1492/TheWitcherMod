...
public class HoneysuckleCropBlock extends CropBlock {
    public HoneysuckleCropBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 3) {
            ...
            HoneysuckleCropBlock.dropStack(world, pos, new ItemStack(ModItems.honeysuckle, j + (bl ? 1 : 0)));
