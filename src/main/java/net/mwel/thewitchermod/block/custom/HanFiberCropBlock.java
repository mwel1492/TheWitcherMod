...
public class HanFiberCropBlock extends CropBlock {
    public HanFiberCropBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 3) {
            ...
            HanFiberCropBlock.dropStack(world, pos, new ItemStack(ModItems.han_fiber, j + (bl ? 1 : 0)));
